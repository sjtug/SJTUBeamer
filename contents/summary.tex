    ...
    \item 经典文档（亦可能比较过时）
          \begin{itemize}
            \item 仔细阅读《一份不太简短的~\LaTeXe{} 介绍》(lshort-zh-cn)~(1--2 天)
                  ...
                  \link{https://mirrors.sjtug.sjtu.edu.cn/CTAN/info/lshort/chinese/lshort-zh-cn.p
                    df}
...
\begin{frame}{扩展阅读}
  \begin{itemize}
    ...
    \item 现代 LaTeX
          ...
          入门讲座（曾祥东）\link{https://github.com/stone-zeng/latex-talk/releases/tag/2019-04-18
          }
    \item “黑科技”：在 \LaTeX{} 中书写 Markdown 进行排版

          \link{https://liam.page/2020/03/30/writing-manuscript-in-Markdown-and-typesetti
            ng-with-LaTeX/}
  \end{itemize}
\end{frame}
    ...
    \item 基本用法
          \begin{itemize}
            \item
                  ...
                  跟踪更改：\verb|git init|、\verb|git add|、\verb|git commit|
            \item 撤销与回滚：\verb|git reset|、\verb|git revert|
            \item

                  分支与高级用法：\verb|git branch|、\verb|git checkout|、\verb|git rebase|
            \item

                  远端仓库操作：\verb|git pull|、\verb|git push|、\verb|git fetch|
            \item 推荐用 VS Code 等进行可视化操作
            \item 参考链接：\link{https://git-scm.com/book/en/v2}

                  \link{https://www.liaoxuefeng.com/wiki/0013739516305929606dd18361248578c67b8067
                    c8c017b000}
          \end{itemize}
    \item 在线 Git 服务
          \begin{itemize}
