...
\ProvidesFile{sjtubeamerdevguide.tex}[2022/11/23 v3.0.0 Development Guide for sjtubeamer (English)]
...
\begin{itemize}
  ...
  \item Build the Overleaf distribution \texttt{sjtubeamer-overleaf.zip}.
\end{itemize}
...
\fcmd{make build-overleaf} This command will build the overleaf distribution in
\verb"build/overleaf" and generate the zipped file at
\verb"./sjtubeamer-overleaf.zip". See \verb"MANIFEST.md" for what it contains.
...
\changes{v3.0.0}{2022/11/22}{Major version release. Start tracking changes.}
\PrintChanges
