...
\ProvidesFile{sjtubeamerdevguide.tex}[2026/01/30 v3.1.2 Development Guide for sjtubeamer (English)]
...
\begin{titlepage}
  ...
  \hskip-8.3em\resizebox{\paperwidth}{!}{\sjtugate[white]}\vskip2.3cm
\end{titlepage}
