...
\verb"CONTRIBUTING.md" is an outline on how to contribute a plugin to \themename{}. Refer to it for acknowledging the basic pipeline on how to contributre. A common template for calling your plugin is as follows:
\begin{verbatim}
