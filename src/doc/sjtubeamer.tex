...
\href{https://mirrors.sjtug.sjtu.edu.cn/CTAN/lang
  uage/chinese/ctex/ctex.pdf#7}{\CTeX{} 宏集手册}。
...
\begin{commentlist}
  ...
  丰富，如果可以使用 \hologo{XeLaTeX} 编译的情况下，尽可能使用
  \textsc{Biber}。
\end{commentlist}
...
\begin{commentlist}
  ...
  Questions/I_have_a_lot_of_tikz%2C_
  matlab2tikz_or_pgfplots_figures%2C_
  so_I%27m_getting_a_compilation_
