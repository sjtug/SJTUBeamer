...
\ProvidesFile{sjtubeamer.tex}[2026/05/20 v3.2.0 User Manual for sjtubeamer (Chinese)]
\documentclass[
    UTF8,
    heading=true,
    12pt,
...
由于 \themename{} 继承了 \cls{beamer} 文档类的特性，您也可以尝试使用 AI
工具对照原始稿子直接生成 \cls{beamer} 代码。
...
如果您通过插件实现了自己的标题页、尾页或者小组件等，
并且希望贡献到这个存储库让更多的人用到的话，欢迎进行
