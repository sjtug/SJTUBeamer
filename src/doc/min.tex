...
\usepackage{biblatex}
\addbibresource{tutorial/ref.bib}	       % gbt!=bibtex
\usepackage{multicol}
...
% 组织
% \logo{
%     \includegraphics{vi/zhlogo.pdf}  % 重定义 logo
% }
\titlegraphic{			       % 标题图像
  \includegraphics{tutorial/head.png}
}
...
\begin{frame}
  ...
  \begin{figure}
    \centering
    \begin{stampbox}
      \includegraphics[height=0.3\textheight]{tutorial/plant.jpg}
    \end{stampbox}
...
\begin{frame}[allowframebreaks]
  ...
  % \bibliography{tutorial/ref}        % gbt=bibtex
\end{frame}
