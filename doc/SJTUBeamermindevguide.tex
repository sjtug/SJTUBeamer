...
\begin{document}
    ...
    However, there are scenarios where you cannot put temporary variables in some package options. In this complex case, the redefinition of those standard colors is required. And that's the reason why \verb"innertheme.sty" gets \verb"color".
