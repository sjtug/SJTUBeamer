...
\begin{document}
    ...
    Disable a warning by redefining a package \textsf{hyperref} macro \cite{hyperref}, where package \textsf{silence} cannot handle.
    ...
    \paragraph{Code block.} Codeblock is created in tcolorbox. The color is redefined in the inner theme to avoid the bad displaying result.
